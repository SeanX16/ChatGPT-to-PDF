...
// @grant        none
// @downloadURL  https://raw.githubusercontent.com/SeanX16/ChatGPT-to-PDF/main/versions/ChatGPT-to-PDF-button-v1.3.2.user.js
...
(function() {
  ...
  if (domain.includes('chatgpt.com')) {
    function createPdfButton() {
      ...
      // ----- 新增：根据 <html lang> 决定按钮文字 -----
      const lang = document.documentElement.lang || navigator.language || '';
      const isZh = lang.startsWith('zh');
      const labelText = isZh ? '另存为PDF' : 'Save as PDF';
      // ----------------------------------------------
      ...
      inner.appendChild(document.createTextNode(labelText));  // <-- 文本
